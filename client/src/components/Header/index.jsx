...
const Header = () => {
  return (
    <>
      <div className="h-[64px] w-10xl fixed top-0 w-full bg-cyan-800 flex justify-between px-[20px] shadow-[0px_0px_10px_0px_rgba(0,0,0,0.5)]  z-10 relative flex items-center">
        <Menu as="div" className="absolute right-[20px] w-10xl">
          <div>
